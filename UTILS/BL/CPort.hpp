...
// (DO NOT EDIT: machine generated header) 'CPort.pas' rev: 5.00
...
enum TBaudRate { brCustom, br110, br300, br600, br1200, br2400, br4800, br9600, br14400, br19200, br38400, 
...
public:
	...
	__property bool TriggersOnRxChar = {read=GetTriggersOnRxChar, write=SetTriggersOnRxChar, nodefault}
		;
	__property Classes::TThreadPriority EventThreadPriority = {read=FEventThreadPriority, write=SetEventThreadPriority
		, nodefault};
...
__published:
	...
	__property StopBits ;
	__property DataBits ;
	__property DiscardNull ;
	__property EventChar ;
	__property Events ;
	__property Buffer ;
	__property FlowControl ;
	__property Timeouts ;
	__property SyncMethod ;
...
public:
	#pragma option push -w-inl
	/* TCustomComPort.Create */ inline __fastcall virtual TComPort(Classes::TComponent* AOwner) : TCustomComPort(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
typedef void __fastcall (__closure *TCustPacketEvent)(System::TObject* Sender, const AnsiString Str, 
	int &Pos);
